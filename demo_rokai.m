...
% Run RoKAI same as before
[KinaseTable2, SiteTable2] = rokai(T2, NetworkData);
...
% Run RoKAI by specifying the identifier type to be 'flanking'
[KinaseTable3, SiteTable3] = rokai(T3, NetworkData, 'Identifier', 'flanking');
